<?php
	...
	class LoadExperimentData implements FixtureInterface, ContainerAwareInterface, OrderedFixtureInterface
	{
		...
		public function load(ObjectManager $manager)
		{
			...
			$s->setUniprotRef($doctrine->getRepository('LFPStructuralAnksMainBundle:Protein')->findOneByUniprot("P55273"));
			...
			$s->setCualCuant("Quant");
			$s->setEquilCinet("Equilibrium");
			$s->setUniprotRef($doctrine->getRepository('LFPStructuralAnksMainBundle:Protein')->findOneByUniprot("P62775"));
			...
			$s->setCualCuant("Quant");
			$s->setEquilCinet("Equilibrium");
			$s->setUniprotRef($doctrine->getRepository('LFPStructuralAnksMainBundle:Protein')->findOneByUniprot("P07207"));
			...
			$s->setCualCuant("Quant");
			$s->setEquilCinet("Equilibrium");
			$s->setUniprotRef($doctrine->getRepository('LFPStructuralAnksMainBundle:Protein')->findOneByUniprot("P42771"));
			...
			$s->setCualCuant("Quant");
			$s->setEquilCinet("Equilibrium");
			$s->setUniprotRef($doctrine->getRepository('LFPStructuralAnksMainBundle:Protein')->findOneByUniprot("O75832"));
			...
			$s->setCualCuant("Quant");
			$s->setEquilCinet("Equilibrium");
			$s->setUniprotRef($doctrine->getRepository('LFPStructuralAnksMainBundle:Protein')->findOneByUniprot("P25963"));
			...
			$s->setCualCuant("Quant");
			$s->setEquilCinet("Equilibrium");
			$s->setUniprotRef($doctrine->getRepository('LFPStructuralAnksMainBundle:Protein')->findOneByUniprot("Q978J0"));
			...
			$s->setCualCuant("Quant");
			$s->setEquilCinet("Equilibrium");
			$s->setUniprotRef($doctrine->getRepository('LFPStructuralAnksMainBundle:Protein')->findOneByUniprot("DARPIN_E3_5"));
			...
			$s->setCualCuant("Quant");
			$s->setEquilCinet("Equilibrium");
			$s->setUniprotRef($doctrine->getRepository('LFPStructuralAnksMainBundle:Protein')->findOneByUniprot("DARPIN_E3_19"));
			...
			$s->setCualCuant("Quant");
			$s->setEquilCinet("Equilibrium");
			$s->setUniprotRef($doctrine->getRepository('LFPStructuralAnksMainBundle:Protein')->findOneByUniprot("DARPIN_4ANK"));
