<?php
	...
	class LoadStructureData implements FixtureInterface, ContainerAwareInterface, OrderedFixtureInterface
	{
		...
		public function load(ObjectManager $manager)
		{
			...
			$s->setPubDate(new \DateTime("1998-11-18"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.70);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("9865693"));
			$s->setNChains(6);
			$s->setSubGroup("Ank");
			$s->setBu(3);
			$s->setBuComp("CDE-ABF");
			...
			$s->setPubDate(new \DateTime("1999-04-12"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.300);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("9865694"));
			$s->setNChains(3);
			$s->setSubGroup("Ank");
			$s->setBu(3);
			$s->setBuComp("ACD");
			...
			$s->setPubDate(new \DateTime("1998-09-16"));
			$s->setMethod("SOLUTION NMR");
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("9353127"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("1998-10-14"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.8);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("9782052"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("1999-01-13"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.8);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("9751050"));
			$s->setNChains(4);
			$s->setSubGroup("Ank");
			$s->setBu(4);
			$s->setBuComp("ABCD");
			...
			$s->setPubDate(new \DateTime("1999-06-01"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.9);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("9751051"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(2);
			$s->setBuComp("AB");
			...
			$s->setPubDate(new \DateTime("2000-07-28"));
			$s->setMethod("SOLUTION NMR");
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("10556039"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("2001-01-10"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.9);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("11124804"));
			$s->setNChains(6);
			$s->setSubGroup("Ank");
			$s->setBu(3);
			$s->setBuComp("ABC-EFG-ACEG-AEFB");
			$manager->persist($s);
			...
			$s->setPubDate(new \DateTime("1998-12-02"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.95);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("9437433"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(2);
			$s->setBuComp("AB");
			...
			$s->setPubDate(new \DateTime("2003-12-16"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.30);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("14583612"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("2001-11-21"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.86);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("11707390"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("2002-10-04"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.50);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("12686541"));
			$s->setNChains(3);
			$s->setSubGroup("Ank");
			$s->setBu(3);
			$s->setBuComp("ABD");
			...
			$s->setPubDate(new \DateTime("2002-10-16"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.25);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("12370184"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A-B");
			...
			$s->setPubDate(new \DateTime("2002-12-11"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.70);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("12456646"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("2003-10-28"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.00);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("14573873"));
			$s->setNChains(3);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A-B-C");
			...
			$s->setPubDate(new \DateTime("2003-05-20"));
			$s->setMethod("X-RAY DIFFRACTION");
			...
			$s->setPubDate(new \DateTime("2003-11-18"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.80);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("14997555"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("1999-09-15"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.10);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("10048928"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(2);
			$s->setBuComp("AB");
			...
			$s->setPubDate(new \DateTime("2004-11-16"));
			$s->setMethod("SOLUTION NMR");
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("15379554"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("2003-10-30"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.00);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("14573599"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("1997-11-19"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.2);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("8875926"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(2);
			$s->setBuComp("AB");
			...
			$s->setPubDate(new \DateTime("2005-08-16"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.901);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("16011479"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A-B");
			...
			$s->setPubDate(new \DateTime("2007-03-13"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.30);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("17292836"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(2);
			$s->setBuComp("AB");
			...
			$s->setPubDate(new \DateTime("2007-07-17"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.20);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("17555716"));
			$s->setNChains(6);
			$s->setSubGroup("Ank");
			$s->setBu(2);
			$s->setBuComp("AB-CD-EF");
			$manager->persist($s);
			...
			$s->setPubDate(new \DateTime("2006-04-04"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(3.250);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("16530044"));
			$s->setNChains(3);
			$s->setSubGroup("Ank");
			$s->setBu(5);
			$s->setBuComp("XYCKM");
			...
			$s->setPubDate(new \DateTime("2006-03-21"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(3.12);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("16530045"));
			$s->setNChains(3);
			$s->setSubGroup("Ank");
			$s->setBu(5);
			$s->setBuComp("BCADE");
			...
			$s->setPubDate(new \DateTime("2007-07-03"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.70);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("17582331"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("2008-02-12"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.99);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("18264113"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A-B");
			...
			$s->setPubDate(new \DateTime("2008-05-13"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.00);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("18480049"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A-B");
			...
			$s->setPubDate(new \DateTime("2008-08-12"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.500);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("18621669"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("2009-06-23"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.99);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("19434754"));
			$s->setNChains(3);
			$s->setSubGroup("Ank");
			$s->setBu(3);
			$s->setBuComp("ACB");
			...
			$s->setPubDate(new \DateTime("2009-12-22"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.300);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("20037586"));
			$s->setNChains(4);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A-B-C-D");
			...
			$s->setPubDate(new \DateTime("1998-03-18"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.150);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("9461436"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(4);
			$s->setBuComp("DEAB");
			...
			$s->setPubDate(new \DateTime("1999-12-22"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.1);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("10601011"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("1999-08-17"));
			$s->setMethod("SOLUTION NMR");
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("9634699"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("2004-06-22"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.70);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("15164081"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(2);
			$s->setBuComp("AB");
			...
			$s->setPubDate(new \DateTime("2005-05-10"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.200);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("15802643"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A-B");
			...
			$s->setPubDate(new \DateTime("2006-06-27"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.20);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("16809337"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A-B");
			...
			$s->setPubDate(new \DateTime("2006-10-31"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.70);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("16882997"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A-B");
			...
			$s->setPubDate(new \DateTime("2008-03-04"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.350);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("17573339"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A-B");
			...
			$s->setPubDate(new \DateTime("2008-02-19"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.700);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("18232717"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("2008-03-11"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.650);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("18305166"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A-B");
			...
			$s->setPubDate(new \DateTime("2008-02-05"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.10);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("18275817"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("2009-08-04"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.57);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("19137598"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A-B");
			...
			$s->setPubDate(new \DateTime("2008-12-02"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.600);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("19074270"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(2);
			$s->setBuComp("AB");
			...
			$s->setPubDate(new \DateTime("2009-12-15"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.90);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("19963065"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(2);
			$s->setBuComp("AB");
			...
			$s->setPubDate(new \DateTime("2010-03-31"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.30);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("20089642"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(2);
			$s->setBuComp("AB");
			...
			$s->setPubDate(new \DateTime("2010-06-09"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(3.38);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("20510928"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("E");
			...
			$s->setPubDate(new \DateTime("2012-07-18"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.8500);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("22702953"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A-B");
			...
			$s->setPubDate(new \DateTime("1999-12-23"));
			$s->setMethod("SOLUTION NMR");
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("10892805"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("2011-03-23"));
			$s->setMethod("SOLUTION NMR");
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("21397186"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("2011-12-14"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.10);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("23333429"));
			$s->setNChains(4);
			$s->setSubGroup("Ank");
			$s->setBu(3);
			$s->setBuComp("ABG-CDH");
			...
			$s->setPubDate(new \DateTime("2011-12-21"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.10);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("23333429"));
			$s->setNChains(4);
			...
			$s->setPubDate(new \DateTime("2010-08-04"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.20);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("20625546"));
			$s->setNChains(3);
			$s->setSubGroup("Ank");
			$s->setBu(2);
			$s->setBuComp("AB-C");
			...
			$s->setPubDate(new \DateTime("2010-12-22"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.05);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("21128684"));
			$s->setNChains(4);
			$s->setSubGroup("Ank");
			$s->setBu(2);
			$s->setBuComp("AB-CD");
			...
			$s->setPubDate(new \DateTime("2010-09-22"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.30);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("22645133"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A-B");
			...
			$s->setPubDate(new \DateTime("2010-11-03"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(3.450);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("20972443"));
			$s->setNChains(5);
			$s->setSubGroup("Ank");
			$s->setBu(8);
			$s->setBuComp("ACBDFEXY");
			$manager->persist($s);
			...
			$s->setPubDate(new \DateTime("2011-05-18"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.700);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("21296164"));
			$s->setNChains(3);
			$s->setSubGroup("Ank");
			$s->setBu(5);
			$s->setBuComp("ABCDE");
			...
			$s->setPubDate(new \DateTime("2010-11-24"));
			$s->setMethod("X-RAY DIFFRACTION");
			...
			$s->setPubDate(new \DateTime("2011-04-27"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.00);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("21458342"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(2);
			$s->setBuComp("AC-BD");
			...
			$s->setKeywords("PROTEIN BINDING, DE NOVO PROTEIN");
			$s->setTitle("In silico and in vitro co-evolution of a high affinity complementary protein-protein interface");
			$s->setPubDate(new \DateTime("2011-04-20"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.300);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("21458342"));
			$s->setNChains(2);
			...
			$s->setPubDate(new \DateTime("2011-10-05"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.90);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("22649097"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("2011-12-07"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.151);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("22153077"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(2);
			$s->setBuComp("AB");
			...
			$s->setPubDate(new \DateTime("2012-01-11"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(3.178);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("22231402"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(2);
			$s->setBuComp("AB");
			...
			$s->setPubDate(new \DateTime("2012-01-18"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.00);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("22307604"));
			$s->setNChains(3);
			$s->setSubGroup("Ank");
			$s->setBu(3);
			$s->setBuComp("ABC");
			...
			$s->setPubDate(new \DateTime("2012-06-13"));
			$s->setMethod("X-RAY DIFFRACTION");
			...
			$s->setPubDate(new \DateTime("2012-04-04"));
			$s->setMethod("X-RAY DIFFRACTION");
			...
			$s->setPubDate(new \DateTime("2012-06-27"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.97);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("22843676"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(2);
			$s->setBuComp("AB");
			...
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("22917970"));
			$s->setNChains(12);
			$s->setSubGroup("Ank");
			$s->setBu(2);
			$s->setBuComp("AB-CD-EF-GH-IJ-KL");
			$manager->persist($s);
			...
			$s->setPubDate(new \DateTime("2013-02-27"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.95);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("23431166"));
			$s->setNChains(3);
			$s->setSubGroup("Ank");
			$s->setBu(6);
			$s->setBuComp("ABCDEF");
			...
			$s->setPubDate(new \DateTime("2013-01-23"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.50);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("23296631"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(4);
			$s->setBuComp("AB");
			...
			$s->setPubDate(new \DateTime("2012-10-31"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.00);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("23104059"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A-B");
			...
			$s->setPubDate(new \DateTime("2012-07-11"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.22);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("22778434"));
			$s->setNChains(4);
			$s->setSubGroup("Ank");
			$s->setBu(3);
			$s->setBuComp("ABF-CDE");
			...
			$s->setPubDate(new \DateTime("2012-05-02"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.900);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("22451937"));
			$s->setNChains(3);
			$s->setSubGroup("Ank");
			$s->setBu(5);
			$s->setBuComp("ABCDE");
			...
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("22791712"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(4);
			$s->setBuComp("ABCD");
			...
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("23084743"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A-B");
			...
			$s->setPubDate(new \DateTime("2004-10-05"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.80);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("15385955"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("2005-09-20"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.06);
			$s->setNChains(4);
			$s->setSubGroup("Ank");
			$s->setBu(2);
			$s->setBuComp("EF-GH-EFGH");
			$manager->persist($s);
			...
			$s->setKeywords("PROTEIN BINDING");
			$s->setTitle("Crystal structure analysis of yeast Nas6p complexed with the proteasome subunit, rpt3");
			$s->setPubDate(new \DateTime("2007-10-16"));
			$s->setMethod("X-RAY DIFFRACTION");
			...
			$s->setPubDate(new \DateTime("2006-07-04"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.90);
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			...
			$s->setPubDate(new \DateTime("2008-12-30"));
			$s->setMethod("SOLUTION NMR");
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("2"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("2009-11-03"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.90);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("19854204"));
			$s->setNChains(3);
			$s->setSubGroup("Ank");
			$s->setBu(4);
			$s->setBuComp("ABCD");
			...
			$s->setKeywords("ONCOPROTEIN");
			$s->setTitle("Structure of the Oncoprotein Gankyrin in Complex with S6 ATPase of the 26S Proteasome");
			$s->setPubDate(new \DateTime("2007-08-28"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.40);
			$s->setNChains(4);
			$s->setSubGroup("Ank");
			...
			$s->setPubDate(new \DateTime("2003-01-28"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.50);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("12461176"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("2003-01-21"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.031);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("12566564"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("2004-05-25"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.24);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("15097997"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(2);
			$s->setBuComp("AB");
			...
			$s->setPubDate(new \DateTime("2006-06-21"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.90);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("16493627"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A-B");
			...
			$s->setPubDate(new \DateTime("2005-08-09"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.15);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("16084385"));
			$s->setNChains(3);
			$s->setSubGroup("Ank");
			$s->setBu(2);
			$s->setBuComp("AB-CD");
			...
			$s->setPubDate(new \DateTime("2007-05-08"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.70);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("17466328"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A-B-C");
			...
			$s->setPubDate(new \DateTime("2007-05-22"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(3.24);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("17502107"));
			$s->setNChains(13);
			$s->setSubGroup("Ank");
			$s->setBu(6);
			$s->setBuComp("ABPCDQ-EFRGHS-IJTKLU");
			$manager->persist($s);
			...
			$s->setPubDate(new \DateTime("2007-11-13"));
			$s->setMethod("X-RAY DIFFRACTION");
			...
			$s->setPubDate(new \DateTime("2008-04-01"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.30);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("18391401"));
			$s->setNChains(3);
			$s->setSubGroup("Ank");
			$s->setBu(2);
			$s->setBuComp("AD-BC");
			...
			$s->setPubDate(new \DateTime("2010-08-18"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.100);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("20851127"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A-B-C-D");
			...
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.900);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("19081931"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("2009-09-08"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.10);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("19740746"));
			$s->setNChains(4);
			$s->setSubGroup("Ank");
			$s->setBu(4);
			$s->setBuComp("ABCD");
			...
			$s->setPubDate(new \DateTime("1999-09-13"));
			$s->setMethod("SOLUTION NMR");
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("10074345"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("1999-08-13"));
			$s->setMethod("SOLUTION NMR");
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("9660926"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(1);
			$s->setBuComp("A");
			...
			$s->setPubDate(new \DateTime("2005-06-07"));
			$s->setMethod("X-RAY DIFFRACTION");
			...
			$s->setPubDate(new \DateTime("2009-06-02"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.200);
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			...
			$s->setPubDate(new \DateTime("2010-06-16"));
			$s->setMethod("X-RAY DIFFRACTION");
			...
			$s->setPubDate(new \DateTime("2010-02-09"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.900);
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			...
			$s->setPubDate(new \DateTime("2012-02-15"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(3.85);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("22325781"));
			$s->setNChains(3);
			$s->setSubGroup("Ank");
			$s->setBu(6);
			$s->setBuComp("KCMRXY");
			...
			$s->setPubDate(new \DateTime("2013-01-30"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.58);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("23806657"));
			$s->setNChains(6);
			$s->setSubGroup("Ank");
			$s->setBu(3);
			$s->setBuComp("ABC-DEF");
			...
			$s->setPubDate(new \DateTime("2013-04-24"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(3.14);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("23572077"));
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			$s->setBu(2);
			$s->setBuComp("AB");
			...
			$s->setPubDate(new \DateTime("2012-08-29"));
			$s->setMethod("X-RAY DIFFRACTION");
			...
			$s->setPubDate(new \DateTime("2012-09-05"));
			$s->setMethod("X-RAY DIFFRACTION");
			...
			$s->setPubDate(new \DateTime("2013-06-12"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(3.19);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("23872990"));
			$s->setNChains(4);
			$s->setSubGroup("Ank");
			$s->setBu(4);
			$s->setBuComp("ABDK");
			...
			$s->setPubDate(new \DateTime("2013-08-21"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.700);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("23868333"));
			$s->setNChains(3);
			$s->setSubGroup("Ank");
			$s->setBu(6);
			$s->setBuComp("ABP");
			...
			$s->setPubDate(new \DateTime("2013-10-16"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.6500);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("24095059"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(2);
			$s->setBuComp("CBDA-DA-CB");
			$manager->persist($s);
			...
			$s->setPubDate(new \DateTime("2012-12-12"));
			$s->setMethod("X-RAY DIFFRACTION");
			...
			$s->setPubDate(new \DateTime("2013-10-23"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.2);
			$s->setNChains(1);
			$s->setSubGroup("Ank");
			...
			$s->setPubDate(new \DateTime("2013-09-04"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(2.842);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("24021814"));
			$s->setNChains(2);
			$s->setSubGroup("Ank");
			$s->setBu(8);
			$s->setBuComp("AB");
			...
			$s->setPubDate(new \DateTime("2013-08-14"));
			$s->setMethod("X-RAY DIFFRACTION");
			$s->setResolution(1.600);
			$s->setPublication($doctrine->getRepository('LFPStructuralAnksMainBundle:Publication')->findOneByPubmedId("23868333"));
			$s->setNChains(1);
